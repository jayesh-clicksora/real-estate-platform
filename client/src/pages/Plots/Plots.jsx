...
// ─── 100% WORKING ROCK-SOLID PREMIUM PLOT & LAND IMAGES (PEXELS CDN) ───
const PLOT_PRESETS = [
...
const GENERATED_PLOTS = Array.from({ length: 100 }, (_, index) => {
  ...
  const imageIdx = (index * 5 + 1) % PLOT_PRESETS.length;
...
function Plots() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F5] font-sans antialiased text-[#1A1A1A]">
      {/* ─── NEW DESIGN: BRUTALIST LUXURY TEXT HERO ─── */}
      ...
      {/* ─── NEW DESIGN: HORIZONTAL WIDE CATALOG STRIPES ─── */}
          ...
          <div className="space-y-6">
            {filteredPlots.map((plot) => {
              ...
              return (
                ...
                >
                  {/* Left Column: Asymmetrical Wide Image Frame */}
                  ...
                  {/* Right Column: Premium Text Architecture Layout */}
                  <div className="flex-1 flex flex-col justify-between space-y-6 lg:py-1">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex flex-col md:flex-row md:items-start justify-between gap-2">
                        ...
                        {/* Big Pricing display on the right */}
